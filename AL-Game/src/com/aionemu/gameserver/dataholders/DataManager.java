...
public final class DataManager {
	...
	public static RandomSpawnData RANDOMSPAWNDATA;
	...
	public static ChallengeTask CHALLENGE_TASK_DATA;
	
	public static VillageLocationData VILLAGE_LOCATION_DATA;
	...
	private DataManager() {
		...
		RANDOMSPAWNDATA = data.randomspawnData;
		CHALLENGE_TASK_DATA = data.challengeTaskData;
		...
		VILLAGE_LOCATION_DATA = data.villageLocationData;
		ITEM_DATA.cleanup();
