 ...
 * 
 * @author Luno, orz Modified by Wakizashi, Maestross
 */
...
public class StaticData {
	...
	@XmlElement(name = "challenge_task")
	public ChallengeTask challengeTaskData;
	
	@XmlElement(name = "random_spawns")
	public RandomSpawnData randomspawnData;
	
	@XmlElement(name = "village_locations")
	public VillageLocationData villageLocationData;
	...
	private void afterUnmarshal(Unmarshaller unmarshaller, Object parent) {
		...
		DataManager.log.info("Loaded " + randomspawnData.size() + " random spawn maps entries");
		...
		DataManager.log.info("Loaded " + villageLocationData.size() + " village location entries");
	}
}
