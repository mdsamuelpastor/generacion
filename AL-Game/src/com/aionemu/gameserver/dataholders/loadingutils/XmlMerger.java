...
public class XmlMerger {
	...
	private static Collection<File> listFiles(File root, boolean recursive) {
		...
		return FileUtils.listFiles(root, FileFilterUtils.andFileFilter(
			FileFilterUtils.andFileFilter(FileFilterUtils.notFileFilter(FileFilterUtils.prefixFileFilter("new")), FileFilterUtils.suffixFileFilter(".xml")), HiddenFileFilter.VISIBLE), dirFilter);
	}
