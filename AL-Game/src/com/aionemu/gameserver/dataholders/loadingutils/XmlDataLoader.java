...
public class XmlDataLoader {
	...
	public StaticData loadStaticData() {
		...
		/*
		 * catch (IllegalAnnotationsException e) { log.error("Error while loading static data", e); throw new
		 * Error("Error while loading static data", e); } catch (FileNotFoundException e) {
		 * log.error("Error while loading static data", e); throw new Error("Error while loading static data", e); } catch
		 * (JAXBException e) { log.error("Error while loading static data", e); throw new
