...
abstract class DataLoader {
	...
	protected void loadData() {
		if (dataFile.isDirectory()) {
			...
			Collection<?> files = FileUtils.listFiles(dataFile, FileFilterUtils.andFileFilter(
				FileFilterUtils.andFileFilter(FileFilterUtils.notFileFilter(FileFilterUtils.nameFileFilter("new")), FileFilterUtils.suffixFileFilter(".txt")), HiddenFileFilter.VISIBLE),
