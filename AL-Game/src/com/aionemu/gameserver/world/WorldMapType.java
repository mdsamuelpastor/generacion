...
public enum WorldMapType {
    ...
    FRAGMENT_OF_DARKNESS_STIGMA(310070000),
    ...
    DRAGON_LORD_SANCTUARY_SOLO(300490000),
    ISRAPHEL(300500000),
    TIAMAT_CITADEL(300510000),
    DRAGON_LORD_SANCTUARY(300520000),
    IDLDF5Re_02(300530000), 
    IDLDF5b_TD(300540000), 
    ARENA_OF_GLORY(300550000),
    COOPERATION_TRAINING_GROUNDS(300570000),
    ...
    ADVANCED_PERSONNAL_HOUSING(900140000),
