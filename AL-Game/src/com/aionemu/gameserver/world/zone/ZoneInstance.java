...
public class ZoneInstance implements Comparable<ZoneInstance> {
	...
	public boolean isSameRaceDuelsAllowed() {
		if (template.getZoneTemplate().getZoneType() != ZoneClassName.DUEL)
			return World.getInstance().getWorldMap(mapId).getTemplate().isSameRaceDuelsAllowed();
	...
	public boolean isOtherRaceDuelsAllowed() {
		if (template.getZoneTemplate().getZoneType() != ZoneClassName.DUEL)
			return World.getInstance().getWorldMap(mapId).getTemplate().isOtherRaceDuelsAllowed();
