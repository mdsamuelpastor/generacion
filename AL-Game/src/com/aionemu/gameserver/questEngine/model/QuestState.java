...
/**
 * @author MrPoke
 * @modified vlog, Rolandas, Maestros
 */
public class QuestState {
	...
	public boolean canRepeatByTime() {
		...
		if ((calendar.get(Calendar.DAY_OF_MONTH) != currentDay.get(Calendar.DAY_OF_MONTH)) && (currentDay.get(Calendar.HOUR_OF_DAY) >= 9 && currentDay.get(Calendar.HOUR_OF_DAY) <= 23)) {
			return true;
		}
		return false;
	}
