...
public class CraftingRewards extends QuestHandler {
	...
	private boolean canLearn(Player player) {
		return levelReward == 500 ? CraftSkillUpdateService.canLearnMoreMasterCraftingSkill(player) : levelReward == 400 ? CraftSkillUpdateService.canLearnMoreExpertCraftingSkill(player) : true;
	}
