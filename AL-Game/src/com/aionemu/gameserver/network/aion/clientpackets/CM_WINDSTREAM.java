		...
		switch(state)
		{
			...
			case 8:
				if (state == 0) {
					...
					PacketSendUtility.broadcastPacket(player, new SM_EMOTION(player, EmotionType.WINDSTREAM_START_BOOST, 0, 0),
						true);
				}
				else if (state == 8) {
					PacketSendUtility.broadcastPacket(player, new SM_EMOTION(player, EmotionType.WINDSTREAM_END_BOOST, 0, 0),
						true);
				}
			...
			case 1:
				...
				PacketSendUtility.broadcastPacket(player, new SM_EMOTION(player, EmotionType.WINDSTREAM, teleportId, distance),
					true);
