...
public class AionConnection extends AConnection {
	...
	private static final PacketProcessor<AionConnection> packetProcessor = new PacketProcessor<AionConnection>(NetworkConfig.PACKET_PROCESSOR_MIN_THREADS, NetworkConfig.PACKET_PROCESSOR_MAX_THREADS,
		NetworkConfig.PACKET_PROCESSOR_THREAD_SPAWN_THRESHOLD, NetworkConfig.PACKET_PROCESSOR_THREAD_KILL_THRESHOLD, new ExecuteWrapper());
	...
	// TODO! we must find an simple and smart way to configure how much invalid packets can send from client to server and what the server then will do [Maestross]
	...
	public String toString() {
		...
		if (player != null) {
			return "AionConnection [state=" + state + ", account=" + account + ", getObjectId()=" + player.getObjectId() + ", lastPlayerName=" + lastPlayerName + ", macAddress=" + macAddress + ", getIP()="
				+ getIP() + "]";
		}
		return "";
	}
