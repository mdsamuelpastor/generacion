 ...
 * 
 * @author alexa026, Sweetkr, Maestross
 */
	...
	protected void writeImpl(AionConnection con) {
		...
		for (Effect effect : effects) {
			...
			if (effected != null) {
				...
				writeC(0); // unk
				int targetHpPercent = (int) (100 * effected.getLifeStats().getCurrentHp() / target.getLifeStats().getMaxHp());
				writeC(targetHpPercent); // target %hp
				writeC((int) (100 * attackerCurrHp / attackerMaxHp)); // attacker %hp
			}
			else {// point point skills
				writeD(0);
				writeC(0);
				writeC(0);
				writeC(100 * attackerCurrHp / attackerMaxHp);
			}
