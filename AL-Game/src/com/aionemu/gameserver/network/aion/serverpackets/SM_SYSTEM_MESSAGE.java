...
public class SM_SYSTEM_MESSAGE extends AionServerPacket
{
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_SKILL_CONFLICT_WITH_OTHER_SKILL(int value0, int value1) {
...
/ChannelHelp: Shows the commands available for channels.
	...
	* %1 of %0 uses %3 in %2.
	*/
	public static SM_SYSTEM_MESSAGE STR_SKILL_ABYSS_SKILL_IS_FIRED(Player player, DescriptionId rankDescId) {
		return new SM_SYSTEM_MESSAGE(1390155, player.getRace().getRaceDescriptionId(), player.getName(), 
			"%SubZone:" + player.getPosition().getMapId() + " " + player.getPosition().getX() + " " + player.getPosition().getY() + " " + player.getPosition().getZ(), rankDescId);
	}
  ...
  public static final SM_SYSTEM_MESSAGE STR_MSG_INSTANCE_DUNGEON_OPENED_FOR_SELF(int worldId)
  {
	...
	*/
	public static SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Ready() {
		return new SM_SYSTEM_MESSAGE(1401330);
	}
	
	public static SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Open() {
		return new SM_SYSTEM_MESSAGE(1401331);
	}
	
	public static SM_SYSTEM_MESSAGE STR_MSG_LDF4a_windpath163_Close() {
		return new SM_SYSTEM_MESSAGE(1401332);
	}
