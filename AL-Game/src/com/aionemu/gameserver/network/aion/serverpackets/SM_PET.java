...
/**
 * @author M@xx, xTz, Rolandas, Maestross
 */
			...
			case 0:
				...
				for (PetCommonData petCommonData : pets) {
					...
					if (petTemplate.ContainsFunction(PetFunctionType.FOOD)) {
						writeD(PetFunctionType.FOOD.getId());
						writeH(petCommonData.getFeedProgress().getDataForPacket());
						writeH((int) petCommonData.getTime() / 1000);
					}
					writeH(PetFunctionType.NONE.getId());
