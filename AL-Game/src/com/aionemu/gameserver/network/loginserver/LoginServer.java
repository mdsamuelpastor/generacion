...
import com.aionemu.gameserver.network.loginserver.serverpackets.SM_REQUEST_TELNET_CONNECTION;
...
public class LoginServer {
	...
	public void requestTelnetConnection(String playerName, String hashPass) {
		if (loginServer != null && loginServer.getState() == State.AUTHED)
			loginServer.sendPacket(new SM_REQUEST_TELNET_CONNECTION(playerName, hashPass));
	}
