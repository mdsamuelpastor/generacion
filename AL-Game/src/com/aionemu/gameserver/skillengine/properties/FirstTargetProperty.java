		...
		switch (value) {
			...
			case TARGET:
				if ((skill.getSkillId() <= 8000) || (skill.getSkillId() >= 9000)) {
					if ((skill.getSkillId() == 1184) && skill.getFirstTarget() == skill.getEffector()
							|| (skill.getSkillId() == 2149) && skill.getFirstTarget() == skill.getEffector()
							|| (skill.getSkillId() == 2575) && skill.getFirstTarget() == skill.getEffector())
						return false;
