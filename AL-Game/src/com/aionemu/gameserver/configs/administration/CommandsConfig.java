...
/**
 * @author vlog TEMPORARY fix, Maestross
 */
public class CommandsConfig {

	@Property(key = "kev", defaultValue = "3")
	...
	@Property(key = "unbug", defaultValue = "1")
	public static int UNBUG;
	...
	@Property(key = "ngc", defaultValue = "0")
	...
	@Property(key = "invultarget", defaultValue = "5")
	public static int INVULTARGET;
	...
	public static int ELYCHAT;
	@Property(key = "asmo", defaultValue = "0")
	public static int ASMOCHAT;
	@Property(key = "world", defaultValue = "0")
	public static int WORLDCHAT;	
	...
	@Property(key = "ex", defaultValue = "0")
	public static int EX;
	@Property(key = "medal", defaultValue = "0")
	public static int MEDAL;
	@Property(key = "eq", defaultValue = "1")
	public static int EQ;
	@Property(key = "enchanting", defaultValue = "0")
	...
	@Property(key = "asmos", defaultValue = "0")
	public static int ASMOS;
	@Property(key = "elyos", defaultValue = "0")
	public static int ELYOS;
	@Property(key = "items", defaultValue = "0")
