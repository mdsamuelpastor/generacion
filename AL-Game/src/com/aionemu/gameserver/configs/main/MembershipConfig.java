...
public class MembershipConfig {
	...
	@Property(key = "gameserver.vip.tag.display", defaultValue = "true")
	public static boolean VIPTAG_DISPLAY;
	
	@Property(key = "gameserver.vip.tag.1", defaultValue = "<PREMIUM>")
	public static String VIP_LEVEL1;
	
	@Property(key = "gameserver.vip.tag.2", defaultValue = "<VIP>")
	public static String VIP_LEVEL2;
	
	@Property(key = "gameserver.special.membership", defaultValue = "false")
	public static boolean SPECIAL_MEMBERSHIP;
	...
	*/
    ...
    @Property(key = "gameserver.onlinebonus.time", defaultValue = "30")
