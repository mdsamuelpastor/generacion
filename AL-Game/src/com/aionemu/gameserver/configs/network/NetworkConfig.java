...
public class NetworkConfig {
	 ...
	 * acceptor thread will also handle read & write. If value is > 0 - there will be given amount of read & write threads
	 * + 1 acceptor thread.
	 */
	...
	/**
	 * Threshold that will be used to decide when extra threads are not needed. (it doesn't have any effect if min threads
	 * == max threads)
	 */
	...
	/**
	 * Threshold that will be used to decide when extra threads should be spawned. (it doesn't have any effect if min
	 * threads == max threads)
	 */
