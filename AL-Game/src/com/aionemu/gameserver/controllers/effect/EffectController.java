...
public class EffectController {
	...
	/**
	 * Method used to calculate number of effects of given dispelcategory, targetslot and dispelLevel used only in
	 * DispelBuffCounterAtk, therefore rest of cases are skipped
	 * 
	 * @param dispelCat
	 * @param targetSlot
	 * @param dispelLevel
		...
		for (Effect effect : abnormalEffectMap.values()) {
			...
			switch (dispelCat) {
				case ALL:// DispelDebuffEffect
					if ((effect.getDispelCategory() == DispelCategoryType.ALL || effect.getDispelCategory() == DispelCategoryType.DEBUFF_MENTAL || effect.getDispelCategory() == DispelCategoryType.DEBUFF_PHYSICAL)
