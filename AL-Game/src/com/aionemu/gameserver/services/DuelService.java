...
public class DuelService {
	...
	private DuelService() {
		...
		drawTasks = new FastMap<Integer, Future<?>>().shared();
	...
	public void onDuelRequest(Player requester, Player responder) {
		...
		if (CustomConfig.DUEL_REWARD_ENABLE) {
		    ItemService.addItem(requester, CustomConfig.DUEL_REWARD_WINNER_ITEM, CustomConfig.DUEL_REWARD_COUNT);
			ItemService.addItem(responder, CustomConfig.DUEL_REWARD_LOSER_ITEM, CustomConfig.DUEL_REWARD_COUNT);
		}
