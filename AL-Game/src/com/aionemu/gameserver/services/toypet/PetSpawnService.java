	...
	public static final void dismissPet(Player player, boolean isManualDespawn) {
		...
		if (toyPet != null) {
			...
			if (progress != null) {
				...
				DAOManager.getDAO(PlayerPetsDAO.class).saveFeedStatus(player, toyPet.getPetId(), progress.getHungryLevel().getValue(), progress.getDataForPacket(), progress.getTotalPoints(),
