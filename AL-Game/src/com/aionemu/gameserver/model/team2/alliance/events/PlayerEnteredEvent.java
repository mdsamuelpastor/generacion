...
public class PlayerEnteredEvent implements Predicate<PlayerAllianceMember>, TeamEvent {
	...
	public void handleEvent() {
		...
		PacketSendUtility.sendPacket(invited, new SM_ALLIANCE_MEMBER_INFO(invitedMember, PlayerAllianceEvent.ENTER));
	...
	public boolean apply(PlayerAllianceMember member) {
		...
		if (!invited.getObjectId().equals(player.getObjectId())) {
			PacketSendUtility.sendPacket(player, new SM_ALLIANCE_MEMBER_INFO(invitedMember, PlayerAllianceEvent.ENTER));
			...
			PacketSendUtility.sendPacket(invited, new SM_ALLIANCE_MEMBER_INFO(member, PlayerAllianceEvent.EFFECTS));
		}
		return true;
	}
