...
public enum AutoGroupsType {
	...
	ARENA_OF_HARMONY_1((byte) 33, 110000, 6, 1),
	ARENA_OF_HARMONY_2((byte) 34, 110000, 6, 2),
	ARENA_OF_HARMONY_3((byte) 35, 110000, 6, 3),
	ARENA_OF_GLORY_1((byte) 38, 110000, 4, 1),
	CHAOS_TRAINING_GROUNDS((byte) 99, 0, 10),
	DISCIPLINE_TRAINING_GROUNDS((byte) 100, 0, 2),
	HARMONY_TRAINING_GROUNDS_1((byte) 101, 110000, 6, 1),
	HARMONY_TRAINING_GROUNDS_2((byte) 102, 110000, 6, 2),
	HARMONY_TRAINING_GROUNDS_3((byte) 103, 110000, 6, 3);
	...
	public boolean isTrainigPvPTeamArena() {
		switch (this) {
			case HARMONY_TRAINING_GROUNDS_1:
			case HARMONY_TRAINING_GROUNDS_2:
			case HARMONY_TRAINING_GROUNDS_3:
				return true;
			default:
				break;
		}
	...
	public boolean isPvPBestPlayerArena() {
		switch (this) {
	...
	public boolean isPvpArena() {
		return isTrainigPvPFFAArena() || isPvPFFAArena() || isTrainigPvPSoloArena() || isPvPSoloArena() || isPvPTeamArena() || isTrainigPvPTeamArena() || isPvPBestPlayerArena();
	}
