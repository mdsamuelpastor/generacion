...
public class PvPArenaReward extends InstanceReward<PvPArenaPlayerReward> {
	...
	public final boolean isTeamArena() {
		return (mapId == 300570000) || (mapId == 300450000);
	}
	...
	public synchronized void clearPosition(int position, Boolean result) {
		positions.put(Integer.valueOf(position), result);
	}
	...
	public boolean canRewardGloryTicket(PvPArenaPlayerReward rewardedPlayer) {
		if (rewardedPlayer != null) {
			int rank = getRank(rewardedPlayer.getPoints());
			return isTeamArena() && rank == 1;
		}
		return false;
	}
	...
	public boolean canRewarded() {
		return mapId == 300350000 || mapId == 300360000 || mapId == 300450000 || mapId == 300550000;
	}
