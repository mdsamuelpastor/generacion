...
@XmlType(name = "InstanceCooltime", propOrder = { "entCoolTime", "maxMemberLight", "maxMemberDark", "enterMinLevelLight", "enterMaxLevelLight", "enterMinLevelDark", "enterMaxLevelDark",
	"can_enter_mentor" })
