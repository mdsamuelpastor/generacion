...
/**
 * @author Luno modified by ATracer, Maestross, GoodT
 */
...
public class ItemTemplate extends VisibleObjectTemplate {
	...
	@XmlAttribute(name = "ap_extract")
    public boolean isAbyssExtractable;
	...
	public boolean isQuestItem() {
		return (getCategory() == ItemCategory.QUEST);
	}
