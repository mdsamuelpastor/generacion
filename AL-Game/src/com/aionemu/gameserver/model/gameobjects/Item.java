...
/**
 * @author ATracer, Wakizashi, xTz, Maestross
 */
public class Item extends AionObject implements IExpirable, StatOwner {
	 ...
	 */
	public Item(int objId, int itemId, long itemCount, int itemColor, String itemCreator, int expireTime, int activationCount, boolean isEquipped, boolean isSoulBound, long equipmentSlot,
        int itemLocation, int enchant, int itemSkin, int fusionedItem, int optionalSocket, int optionalFusionSocket, int charge) {
        super(objId);
	...
	public String toString() {
		return "Item [itemId=" + itemTemplate.getTemplateId() + " equipmentSlot=" + equipmentSlot + ", godStone=" + godStone + ", isEquipped=" + isEquipped + ", itemColor=" + itemColor + ", itemCount="
			+ itemCount + ", itemLocation=" + itemLocation + ", itemTemplate=" + itemTemplate + ", manaStones=" + manaStones + ", persistentState=" + persistentState + "]";
	}
	...
	public int getChargeLevel() {
		if (getChargePoints() == 0)
			return 0;
		return getChargePoints() > 500000 ? 2 : 1;
	}
