...
public class Equipment {
	...
	private static final long[] ARMOR_SLOTS = new long[] { ItemSlot.BOOTS.getSlotIdMask(), ItemSlot.GLOVES.getSlotIdMask(), ItemSlot.PANTS.getSlotIdMask(), ItemSlot.SHOULDER.getSlotIdMask(),
		...
		switch (item.getItemTemplate().getWeaponType().getRequiredSlots()) {
			...
			case 1:
				...
				if (itemInMainHand != null
					&& (!owner.getSkillList().isSkillPresent(19) && !owner.getSkillList().isSkillPresent(360) && !owner.getSkillList().isSkillPresent(127) && !owner.getSkillList().isSkillPresent(128) && !owner
