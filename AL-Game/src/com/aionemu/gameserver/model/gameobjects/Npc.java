...
public class Npc extends Creature {
	...
	public boolean guardAgainst(Npc npc) {
		/*
		 * Until further testing or reports, npc's will not attack npc's with same name(self). Only happens with guard type
		 * npc's. This fixes certain NPC's like ascension that should not attack each other breaking the quest. Example:
