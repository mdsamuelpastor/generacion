...
public enum CustomMessageId {
	...
	WELCOME_BASIC("Willkommen auf dem Server von : "),
	HOMEPAGE("Homepage: www.celestialaion.com"),
	TEAMSPEAK("Teamspeak3: celestialaion.com"),
	INFO1("Achtung: Das werben fuer andere Server ist verboten und wird einen Bann zu folge haben."),
	INFO2("Achtung: Das Team wird dich niemals nach deinem Passwort fragen!"),
	INFO3("Achtung: Das Hacken auf unserem Server hat ein sofortigen Bann zu folge."),
	INFO4("Tipp: Tippe .faction ein um den Fraktions Chat zu benutzen."),
	ENDMESSAGE("Viel Spass auf: "),
	ANNOUNCE_GM_CONNECTION(" betrat gerade Atreia!"),
	...
	MSG_SPREE1(" it's an "),
	MSG_SPREE1_1(" !"),
	MSG_SPREE2(" performs an "),
	MSG_SPREE2_1(" ! Stop it !"),
	MSG_SPREE3(" realizes a true "),
	MSG_SPREE3_1(" ! you flee fool !"),
    SPREE_END_MSG1("The bloodlust of "),
	SPREE_END_MSG2(" was "),
	SPREE_END_MSG3(" after "),
	SPREE_END_MSG4(" Kills ended!"),
	 ...
	 * Advanced PvP System
	 */
	PVP_ADV_MESSAGE1("Today PvP Advanced Map: Reshanta"),
	PVP_ADV_MESSAGE2("Today PvP Advanced Map: Tiamaranta"),
	PVP_ADV_MESSAGE3("Today PvP Advanced Map: Tiamat Down"),
	PVP_ADV_MESSAGE4("Today PvP Advanced Map: Gelkmaros"),
	PVP_ADV_MESSAGE5("Today PvP Advanced Map: Inggison"),
    ...
    /**
	 * Faction Chat related (since 3.0 we don't use it more)
	 */
	INFOMESSAGE("If you want to chat: "),
