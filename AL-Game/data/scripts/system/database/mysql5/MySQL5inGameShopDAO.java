...
public class MySQL5inGameShopDAO extends InGameShopDAO {
	...
	@Override
	public void saveIngameShopItem(int objectId, int itemId, long itemCount, long itemPrice, byte category, byte subCategory, int list, int salesRanking, byte itemType, byte gift,
		String titleDescription, String description) {
		Connection con = null;
		try {
			con = DatabaseFactory.getConnection();
