...
public class MySQL5InventoryDAO extends InventoryDAO {
	...
	public static final String DELETE_CLEAN_QUERY = "DELETE FROM inventory WHERE item_owner=? AND item_location != 2"; // legion																																																										// IDAwareDAOs
	...
	private boolean insertItems(Connection con, Collection<Item> items, Integer playerId, Integer accountId, Integer legionId) {
		...
		try {
			...
			for (Item item : items) {
				...
				stmt.setLong(11, item.getEquipmentSlot());
