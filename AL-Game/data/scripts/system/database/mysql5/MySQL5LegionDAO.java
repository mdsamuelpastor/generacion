...
public class MySQL5LegionDAO extends LegionDAO {
	...
	private static final String UPDATE_LEGION_QUERY = "UPDATE legions SET name=?, level=?, contribution_points=?, deputy_permission=?, centurion_permission=?, legionary_permission=?, volunteer_permission=?, disband_time=?, done_count1=?, done_count2=?, done_count3=?, done_count4=?, done_count5=?, done_count6=?, done_count7=?, done_count8=?, done_count9=?, done_count10=?, done_count11=?, done_count12=?, done_count13=?, done_count14=?, done_count15=?, done_count16=?, done_count17=?, done_count18=? WHERE id=?";
	...
	public void storeLegion(final Legion legion) {
		DB.insertUpdate(UPDATE_LEGION_QUERY, new IUStH() {
			...
			public void handleInsertUpdate(PreparedStatement stmt) throws SQLException {
				...
				stmt.setInt(9, legion.getDoneCountQuest1());
				stmt.setInt(10, legion.getDoneCountQuest2());
				stmt.setInt(11, legion.getDoneCountQuest3());
				stmt.setInt(12, legion.getDoneCountQuest4());
				stmt.setInt(13, legion.getDoneCountQuest5());
				stmt.setInt(14, legion.getDoneCountQuest6());
				stmt.setInt(15, legion.getDoneCountQuest7());
				stmt.setInt(16, legion.getDoneCountQuest8());
				stmt.setInt(17, legion.getDoneCountQuest9());
				stmt.setInt(18, legion.getDoneCountQuest10());
				stmt.setInt(19, legion.getDoneCountQuest11());
				stmt.setInt(20, legion.getDoneCountQuest12());
				stmt.setInt(21, legion.getDoneCountQuest13());
				stmt.setInt(22, legion.getDoneCountQuest14());
				stmt.setInt(23, legion.getDoneCountQuest15());
				stmt.setInt(24, legion.getDoneCountQuest16());
				stmt.setInt(25, legion.getDoneCountQuest17());
				stmt.setInt(26, legion.getDoneCountQuest18());
				stmt.setInt(27, legion.getLegionId());
				stmt.execute();
			}
		});
	}
		...
		boolean success = DB.select(SELECT_LEGION_QUERY2, new ParamReadStH() {
			...
			public void handleRead(ResultSet resultSet) throws SQLException {
				while (resultSet.next()) {
					...
					legion.setDoneCountQuest1(resultSet.getInt("done_count1"));
					legion.setDoneCountQuest2(resultSet.getInt("done_count2"));
					legion.setDoneCountQuest3(resultSet.getInt("done_count3"));
					legion.setDoneCountQuest4(resultSet.getInt("done_count4"));
					legion.setDoneCountQuest5(resultSet.getInt("done_count5"));
					legion.setDoneCountQuest6(resultSet.getInt("done_count6"));
					legion.setDoneCountQuest7(resultSet.getInt("done_count7"));
					legion.setDoneCountQuest8(resultSet.getInt("done_count8"));
					legion.setDoneCountQuest9(resultSet.getInt("done_count9"));
					legion.setDoneCountQuest10(resultSet.getInt("done_count10"));
					legion.setDoneCountQuest11(resultSet.getInt("done_count11"));
					legion.setDoneCountQuest12(resultSet.getInt("done_count12"));
					legion.setDoneCountQuest13(resultSet.getInt("done_count13"));
					legion.setDoneCountQuest14(resultSet.getInt("done_count14"));
					legion.setDoneCountQuest15(resultSet.getInt("done_count15"));
					legion.setDoneCountQuest16(resultSet.getInt("done_count16"));
					legion.setDoneCountQuest17(resultSet.getInt("done_count17"));
					legion.setDoneCountQuest18(resultSet.getInt("done_count18"));			
					legion.addContributionPoints(resultSet.getLong("contribution_points"));

					legion.setLegionPermissions(resultSet.getShort("deputy_permission"), resultSet.getShort("centurion_permission"), resultSet.getShort("legionary_permission"),
		...
		DB.select(SELECT_STORAGE_QUERY, new ParamReadStH() {
			...
			public void handleRead(ResultSet rset) throws SQLException {
				while (rset.next()) {
					...
					Item item = new Item(itemUniqueId, itemId, itemCount, itemColor, itemCreator, expireTime, activationCount, isEquiped == 1, false, slot, storage, enchant, itemSkin, fusionedItem,
	...
	public void loadLegionHistory(final Legion legion) {
		...
		DB.select(SELECT_HISTORY_QUERY, new ParamReadStH() {
			...
			public void handleRead(ResultSet resultSet) throws SQLException {
				while (resultSet.next()) {
					history.add(new LegionHistory(LegionHistoryType.valueOf(resultSet.getString("history_type")), resultSet.getString("name"), resultSet.getTimestamp("date"), resultSet.getInt("tab_id"),
