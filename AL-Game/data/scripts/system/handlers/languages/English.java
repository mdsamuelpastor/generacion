...
public class English extends Language {
	...
	public English() {
		...
		addTranslatedMessage(CustomMessageId.INFO1, "Note: The advertising for other servers is prohibited and will have a ban to follow!");
		addTranslatedMessage(CustomMessageId.INFO2, "Note: The team will never ask you for your password!");
		addTranslatedMessage(CustomMessageId.INFO3, "Warning: The hacking on our server has to follow one immediate Ban.");
		addTranslatedMessage(CustomMessageId.INFO4, "Tip: Use .ely / .asmo hand to use the faction chat.");
		 ...
		 * PvP Spree Service
		 */
		addTranslatedMessage(CustomMessageId.SPREE1, "Bloody Madness");
		addTranslatedMessage(CustomMessageId.SPREE2, "Bloodbath");
		addTranslatedMessage(CustomMessageId.SPREE3, "Genocide");
		addTranslatedMessage(CustomMessageId.KILL_COUNT, "Kills in a row: ");
		addTranslatedMessage(CustomMessageId.CUSTOM_MSG1, " from ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE1, " it's an ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE1_1, " !");
		addTranslatedMessage(CustomMessageId.MSG_SPREE2, " performs an ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE2_1, " ! Stop it !");
		addTranslatedMessage(CustomMessageId.MSG_SPREE3, " realizes a true ");
		addTranslatedMessage(CustomMessageId.MSG_SPREE3_1, " ! you flee fool !");
		addTranslatedMessage(CustomMessageId.SPREE_END_MSG1, "The bloodlust of ");
		addTranslatedMessage(CustomMessageId.SPREE_END_MSG2, " was ");
		addTranslatedMessage(CustomMessageId.SPREE_END_MSG3, " after ");
		addTranslatedMessage(CustomMessageId.SPREE_END_MSG4, " Kills ended!");
		...
		addTranslatedMessage(CustomMessageId.PVP_ADV_MESSAGE3, "Today PvP Map: Tiamaranta Auge");
		...
		addTranslatedMessage(CustomMessageId.NO_GM_ONLINE, "It's not a team member online!");
		 ...
		 */
		addTranslatedMessage(CustomMessageId.LEGENDARY_RAID_SPAWNED_ASMO, "[Legendary Raid Spawn Event] Ragnarok was spawned for Asmodians at Beluslan!");
		addTranslatedMessage(CustomMessageId.LEGENDARY_RAID_SPAWNED_ELYOS, "[Legendary Raid Spawn Event] Omega was spawned for Elyos at Heiron!");
		addTranslatedMessage(CustomMessageId.LEGENDARY_RAID_DESPAWNED_ASMO, "[Legendary Raid Spawn Event] Ragnarok was unspawned, nobody kill him!");
		addTranslatedMessage(CustomMessageId.LEGENDARY_RAID_DESPAWNED_ELYOS, "[Legendary Raid Spawn Event] Omega was unspawned, nobody kill him!");
