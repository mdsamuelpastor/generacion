...
/**
 * @author loleron pieced together from DyeAction.java, Set.java, Maestros
 */
public class Paint extends ChatCommand {
	...
	public void execute(Player player, String... params) {
		...
		if (target == null) {
			PacketSendUtility.sendMessage(player, LanguageHandler.translate(CustomMessageId.WRONG_TARGET));
			return;
		}
		...
		try {
			...
			if (!color.equalsIgnoreCase("no")) {
				PacketSendUtility.sendMessage(player, "[Paint] Farbe unbekannt: " + color);
				return;
			}
		}
		...
		PacketSendUtility.sendMessage(player, "Erfolgreich gefaerbt!");
	}
