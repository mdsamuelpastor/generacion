...
public class HonorItems extends ChatCommand {
	...
	private void plateInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.PLATE_ARMOR_PRICES));
	...
	private void leatherInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.LEATHER_ARMOR_PRICES));
		PacketSendUtility.sendMessage(player, "----------------");
	...
	private void clothInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CLOTH_ARMOR_PRICES));
		PacketSendUtility.sendMessage(player, "----------------");
	...
	private void chainInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CHAIN_ARMOR_PRICES));
		PacketSendUtility.sendMessage(player, "----------------");
	...
	private void weaponsInfo(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.WEAPONS_PRICES));
		PacketSendUtility.sendMessage(player, "----------------");
	...
	private void plate(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.PLATE_ARMOR));
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.PLATE_ARMOR_USE_INFO));
	}
	
	private void leather(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.LEATHER_ARMOR));
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.LEATHER_ARMOR_USE_INFO));
	}
	
	private void cloth(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CLOTH_ARMOR));
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CLOTH_ARMOR_USE_INFO));
	}
	
	private void chain(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CHAIN_ARMOR));
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.CHAIN_ARMOR_USE_INFO));
	}
	
	private void weapons(Player player) {
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.WEAPONS));
		PacketSendUtility.sendMessage(player, "----------------");
		...
		PacketSendUtility.sendMessage(player, "----------------");
		PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.WEAPONS_USE_INFO));
	}
	...
	private void case1(Player player) {//Plate Breast
		...
		if (player.getAbyssRank().getAp() < ap) {
            PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.NOT_ENOUGH_AP2) + ap);
            return;
        }
		if (itemsInBag < count) {
			PacketSendUtility.sendYellowMessageOnCenter(player, LanguageHandler.translate(CustomMessageId.NOT_ENOUGH_MEDALS) + count);
			return;
		}
		...
		PacketSendUtility.sendMessage(player, LanguageHandler.translate(CustomMessageId.SUCCESSFULLY_TRADED));
	}
