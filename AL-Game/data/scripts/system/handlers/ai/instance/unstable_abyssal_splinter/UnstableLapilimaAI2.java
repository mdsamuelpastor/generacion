...
public class UnstableLapilimaAI2 extends NpcAI2 {

    @Override
    protected void handleSpawned() {
        super.handleSpawned();
        Npc yameness = getPosition().getWorldMapInstance().getNpc(219943);
        Npc yamennesHard = getPosition().getWorldMapInstance().getNpc(219951);
        final Npc lapilima = getPosition().getWorldMapInstance().getNpc(219954);

        if (lapilima != null && !lapilima.getLifeStats().isAlreadyDead()) {
            if (yameness != null) {
                AI2Actions.targetCreature(UnstableLapilimaAI2.this, getPosition().getWorldMapInstance().getNpc(219954));
