				...
				if (!canThink && isInState(AIState.WALKING)) {
					if (!isAlreadyDead()) {
						...
						if (instance != null) {
							...
							if (robot != null && !CreatureActions.isAlreadyDead(robot)) {
								Npc chastisement = instance.getNpc(282269);
								if (chastisement != null && !CreatureActions.isAlreadyDead(chastisement)) {
			...
			public void run() {
				if (getNpcId() == 217241) {
					...
					if (obj != null && obj instanceof Npc && ((Npc) obj).getNpcId() != 730393) {
						CreatureActions.delete((Npc) obj);
					}
				}
				canThink = true;
				...
				if (creature == null || creature.getLifeStats().isAlreadyDead() || !getOwner().canSee(creature)) {
					...
					if (getNpcId() == 217242) {
						...
						if (chastisement != null && !CreatureActions.isAlreadyDead(chastisement)) {
							CreatureActions.delete(chastisement);
						}
						startPhaseTask();
						startStopThikTask();
					}
