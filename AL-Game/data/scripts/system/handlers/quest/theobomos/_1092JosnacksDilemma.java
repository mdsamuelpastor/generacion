	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (targetId == 700390 && var == 4 && (bag.getItemCountByItemId(182208012) < 6)) {
				...
				QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 214552, searchResult.getSpot().getX(), searchResult.getSpot().getY(), searchResult.getSpot().getZ(), searchResult
					.getSpot().getHeading());
				return true;
			}
		}
