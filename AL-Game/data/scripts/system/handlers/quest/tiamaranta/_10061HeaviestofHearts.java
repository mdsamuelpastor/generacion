...
public class _10061HeaviestofHearts extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (qs.getStatus() == QuestStatus.START) {
			...
			else if (targetId == 800019) { //garnon
				switch (dialog) {
					case START_DIALOG: {
						if (var == 2) {
					...
					case STEP_TO_3: {
						...
						Npc garnonGray = (Npc) QuestService.addNewSpawn(player.getWorldId(), player.getInstanceId(), 800081,
							2468f, 164f, 327f, (byte) 20);
	...
	private void spawnAndAttack(Player player, Npc target) {
		Npc spawn1 = (Npc) QuestService.addNewSpawn(600030000, player.getInstanceId(), 218825, 2463f, 156f, 327f, (byte) 0);
		Npc spawn2 = (Npc) QuestService.addNewSpawn(600030000, player.getInstanceId(), 218765, 2451f, 157f, 323f, (byte) 0);
		Npc spawn3 = (Npc) QuestService.addNewSpawn(600030000, player.getInstanceId(), 218825, 2445f, 167f, 322f, (byte) 0);
		Npc spawn4 = (Npc) QuestService.addNewSpawn(600030000, player.getInstanceId(), 218825, 2446f, 178f, 320f, (byte) 0);
		Npc spawn5 = (Npc) QuestService.addNewSpawn(600030000, player.getInstanceId(), 218825, 2450f, 191f, 320f, (byte) 0);
