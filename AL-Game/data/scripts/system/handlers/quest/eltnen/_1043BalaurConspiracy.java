					...
					if (qs.getQuestVarById(0) == 2) {
						...
						ThreadPoolManager.getInstance().schedule(new Runnable() {
							...
							public void run() {
								...
								TeleportService2.teleportTo(player, 310040000, newInstance.getInstanceId(), (float) 270.5, (float) 174.3, (float) 204.3);
							}
						}, 3000);
						return true;
					}
				case 204044: {
					switch (env.getDialog()) {
						...
						case STEP_TO_4: {
							...
							updateQuestStatus(env);
							TeleportService2.teleportTo(player, WorldMapType.ELTNEN.getId(), 2502.1948f, 782.9152f, 408.97723f);
							return true;
						}
						default:
							break;
