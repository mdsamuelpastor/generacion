...
public class _28623KaligasCollection extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 730331) {
			...
			if ((playerClass == PlayerClass.TEMPLAR || playerClass == PlayerClass.CHANTER || playerClass == PlayerClass.CLERIC || playerClass == PlayerClass.MAGE || playerClass == PlayerClass.PRIEST
				|| playerClass == PlayerClass.GLADIATOR || playerClass == PlayerClass.WARRIOR || playerClass == PlayerClass.SCOUT)
