...
public class _28627KaligasCollection extends QuestHandler {
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 730335) {
			...
			if ((playerClass == PlayerClass.CHANTER || playerClass == PlayerClass.CLERIC || playerClass == PlayerClass.TEMPLAR || playerClass == PlayerClass.WARRIOR || playerClass == PlayerClass.MAGE
