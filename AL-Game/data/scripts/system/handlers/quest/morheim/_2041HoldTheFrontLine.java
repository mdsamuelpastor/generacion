					...
					switch (env.getDialog()) {
						...
						case STEP_TO_3: {
							...
							if (!areSpawned) {
								...
								// Crusader (2)
								mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 211624, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
								mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 211624, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
								// Draconute Scout (2)
								mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 280818, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
								mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 280818, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
				...
				if (var1 >= 0 || var1 < 3) {
					...
					switch (targetId) {
						...
						case 280818:
							...
							mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 213578, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
					...
					switch (targetId) {
						...
						case 213578:
							...
							mobs.add((Npc) QuestService.addNewSpawn(320040000, player.getInstanceId(), 213579, 254.21326f, 256.9302f, 226.6418f, (byte) 93));
