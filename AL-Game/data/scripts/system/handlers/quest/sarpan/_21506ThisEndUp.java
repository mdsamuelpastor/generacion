...
public class _21506ThisEndUp extends QuestHandler {

    private final static int questId = 21506;

    public _21506ThisEndUp() {
        super(questId);
    }
    ...
    public void register() {
        ...
        qe.registerQuestNpc(205711).addOnTalkEvent(questId);
