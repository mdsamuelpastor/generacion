...
public class _41466Crafting_the_Light_of_Innocence extends QuestHandler {

    private final static int questId = 41466;

    public _41466Crafting_the_Light_of_Innocence() {
        super(questId);
    }
                    ...
                    switch (dialog) {
                        ...
                        case CHECK_COLLECTED_ITEMS_SIMPLE:
                            if (QuestService.collectItemCheck(env, true)) {
                                player.getInventory().decreaseByItemId(182213233, 145);
