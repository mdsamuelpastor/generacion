...
public class AddTitle extends ChatCommand {
	...
	public void execute(Player player, String... params) {
		...
		if ((titleId > 260) || (titleId < 1)) {
			PacketSendUtility.sendMessage(player, "title id " + titleId + " is invalid (must be between 1 and 260)");
			return;
		}
		...
		if (titleId < 261)
			titleId = target.getRace().getRaceId() * 260 + titleId;
