...
public class Gameshop extends ChatCommand {
	...
	public void execute(Player admin, String... params) {
		...
		if ("delete".startsWith(params[0])) {
			...
			DAOManager.getDAO(InGameShopDAO.class).saveIngameShopItem(IDFactory.getInstance().nextId(), itemId, count, price, category, subCategory, list - 1, 1, itemType, gift, titleDescription,
				description);
