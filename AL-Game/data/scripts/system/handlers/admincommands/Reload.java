...
public class Reload extends ChatCommand {
	...
	public void execute(Player admin, String... params) {
		...
		/**
		 * else if (params[0].equals("drop")) { NpcDropData npcDropData = NpcDropData.load(); DataManager.NPC_DROP_DATA =
		 * npcDropData; PacketSendUtility.sendMessage(admin, "NpcDrops successfully reloaded!"); }
		 */
