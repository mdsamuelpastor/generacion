...
public class CrucibleChallengeInstance extends CrucibleInstance {
	...
	public boolean onDie(final Player player, Creature lastAttacker) {
		...
		int place = 0;
		if (isInZone(ZoneName.get("ILLUSION_STADIUM_5_300320000"), player)) { // stage 1
			place = 1;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_9_300320000"), player)) { // stage 2
			place = 2;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_6_300320000"), player)) { // stage 3
			place = 3;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_2_300320000"), player)) { // stage 4
			place = 4;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_7_300320000"), player)) { // stage 4
			place = 5;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_3_300320000"), player)) { // stage 5
			place = 6;
		}
		else if (isInZone(ZoneName.get("ILLUSION_STADIUM_8_300320000"), player)) { // stage 6
			place = 7;
		}
