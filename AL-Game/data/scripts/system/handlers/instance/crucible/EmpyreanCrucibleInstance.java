...
public class EmpyreanCrucibleInstance extends CrucibleInstance {
    ...
    public void onEnterInstance(Player player) {
        ...
        CruciblePlayerReward playerReward = getPlayerReward(object);
    ...
    public void onDie(Npc npc) {
		...
		switch (npc.getNpcId()) {
			...
			case 217597:
				...
				sp(217598, 1294.7261f, 1721.1761f, 317.4f, (byte) 105, 6000);
				}
				break;
			case 217598:
				despawnNpc(npc);
				sendEventPacket(StageType.START_STAGE_9_ROUND_5, 2000);
				sp(217599, 1311.5238f, 1755.2079f, 317.4f, (byte) 105, 6000);
				break;
			case 217599:
				despawnNpc(npc);
				//Todo add timer and npcdespawn
				sendEventPacket(StageType.PASS_GROUP_STAGE_9, 2000);
				sendEventPacket(StageType.START_BONUS_STAGE_9, 6000);
				sp(217754, 1276.3323f, 1743.1119f, 317.375f, (byte) 78, 6000);
				sendMsg(1400984);
				break;
			case 217754:
				sp(205343, 1282.5399f, 1755.8711f, 317.4f, (byte) 105, 6000);
				break;
			case 217600:
			case 217601:
			case 217602:
			...
			if (getNpcs(217600).isEmpty() && getNpcs(217601).isEmpty() && getNpcs(217602).isEmpty())
				...
				sp(217603, 1780.8527f, 1276.3375f, 394.3f, (byte) 82, 3000);
				sp(217604, 1756.2661f, 1305.561f, 394.3f, (byte) 82, 3000);
				sp(217605, 1774.0984f, 1270.6729f, 394.3f, (byte) 84, 3000);
				}
				break;
			case 217603:
			case 217604:
			...
			if (getNpcs(217603).isEmpty() && getNpcs(217604).isEmpty() && getNpcs(217605).isEmpty())
			{
				...
				sp(217607, 1771.2675f, 1304.7964f, 394.3f, (byte) 82, 3000);
			}
				break;
			case 217607:
				despawnNpc(npc);
				sendEventPacket(StageType.START_STAGE_10_ROUND_4, 2000);
				sp(217608, 1754.8065f, 1303.702f, 394.3f, (byte) 82, 3000);
				break;
			case 217608:
				despawnNpc(npc);
				sendEventPacket(StageType.START_STAGE_10_ROUND_5, 2000);
				sp(217609, 1765.6692f, 1288.092f, 394.3f, (byte) 82, 3000);
				break;
			case 217609:
				despawnNpc(npc);
				sendEventPacket(StageType.PASS_GROUP_STAGE_10, 2000);
				sp(205344, 1771.213f, 1302.0781f, 394.3f, (byte) 82, 3000);
				break;
		}
	}
    ...
    public boolean onDie(final Player player, Creature lastAttacker) {
        ...
        int place = 0;
        if (isInZone(ZoneName.get("ILLUSION_STADIUM_6_300300000"), player)) { // stage 1 ~ 4
            place = 1;
        } else if (isInZone(ZoneName.get("ILLUSION_STADIUM_300300000"), player)) { // stage 5
            place = 2;
        } else if (isInZone(ZoneName.get("ILLUSION_STADIUM_7_300300000"), player)) { // stage 6
            place = 3;
        } else if (isInZone(ZoneName.get("ILLUSION_STADIUM_4_300300000"), player)) { // stage 7
            place = 4;
        }
	...
	public void onChangeStage(final StageType type) {
		switch (type) {
			...
			case START_STAGE_10_ROUND_1:
                sendEventPacket(type, 2000);
                sp(217600, 1771.213f, 1302.0781f, 394.3f, (byte) 82, 3000);
                sp(217601, 1774.4563f, 1302.1516f, 394.3f, (byte) 82, 3000);
                sp(217602, 1765.1488f, 1305.1216f, 394.3f, (byte) 84, 3000);
                break;
			case START_STAGE_5:
