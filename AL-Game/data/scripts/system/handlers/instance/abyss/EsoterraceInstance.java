...
public class EsoterraceInstance extends GeneralInstanceHandler {
	...
	public void onInstanceCreate(WorldMapInstance instance) {
		...
		if (Rnd.get(0, 100) < 22) {
			...
			spawn(217287, 1038.565f, 984.3627f, 327.35095f, (byte) 57);
			getNpc(799581).getController().onDelete();
		}
	}
	...
	public void onDie(Npc npc) {
		switch (npc.getObjectTemplate().getTemplateId()) {
		    case 217287:
			    spawn(701025, 1038.565f, 984.3627f, 327.35095f, (byte) 106);
				break;
			case 282295:
				openDoor(39);
				break;
	...
	private void giveItem(Player player) {
		ItemService.addItem(player, 185000111, 1);
    }
	...
	public void onEnterZone(Player player, ZoneInstance zone) {
		if (zone.getAreaTemplate().getZoneName() == ZoneName.get("NARAYANA_CANYON_300250000")) {
		...
		if (zone.getAreaTemplate().getZoneName() == ZoneName.get("NARAYANA_CANYON_300250000")) {
			PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 473));
		}
	}
