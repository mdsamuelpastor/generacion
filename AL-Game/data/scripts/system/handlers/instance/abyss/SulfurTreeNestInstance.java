...
public class SulfurTreeNestInstance extends GeneralInstanceHandler {
	...
	private void spawnRings() {
		FlyRing f1 = new FlyRing(new FlyRingTemplate("SULFUR_1", mapId, new Point3D(462.9394, 380.34888, 168.97256), new Point3D(462.9394, 380.34888, 174.97256),
	...
	public boolean onReviveEvent(Player player) {
		...
		TeleportService2.teleportTo(player, mapId, instanceId, 462.69693f, 336.54623f, 162.81717f, (byte) 29);
		return true;
	}
